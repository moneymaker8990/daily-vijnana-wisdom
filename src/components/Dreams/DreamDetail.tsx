...
export function DreamDetail({ dream, onBack, onEdit, onDelete, isPremium = true, onUpgrade }: DreamDetailProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <button
          onClick={() => {
            if (!isPremium && !dream.interpretation) {
              onUpgrade?.();
            } else {
        ...
        >
          <svg className="w-6 h-6 text-violet-300 group-hover:scale-110 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {!isPremium && !dream.interpretation && (
